...
|semantic|Model|semPrefixes|prefixesTtl|Transform will set aside for use in other semantic stereotypes a list of IRI prefixes. The prefixesTtl tag is Turtle code that specifies these prefixes. You don't need to define common prefixes like owl, rdf, foaf; for a complete list of pre-defined prefixes, see <http://docs.marklogic.com/sem:prefixes>. |
