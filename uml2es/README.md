...
- examples/hr_no_es: A similar HR example that does not use Entity Services. Rather, using the extended model, we generate data hub harmonization code for the content, headers, triples, and writer modules. 
